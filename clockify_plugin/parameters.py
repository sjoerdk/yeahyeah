...
class TimeParamType(click.ParamType):
    """A parameter to indicate the time
    ...
    def convert(self, value, param, ctx):
        ...
        if self.absolute_time.match(value):
            ...
            try:
                return utcnow().replace(hour=int(hour), minute=int(minute))
            ...
            return utcnow() + datetime.timedelta(hours=int(hours), minutes=int(minutes))
            ...
            return utcnow() + datetime.timedelta(minutes=int(minutes))
